...
namespace MedioClinic.Extensions
{
    public static class FormExtensions
    {
        ...
        public static MvcHtmlString CustomInput(this HtmlHelper helper, string inputType, string name, object value,
        ...
        {
            return CustomInput(helper, inputType, name, value,
